...
_base_ = [
    ...
    '../_base_/datasets/uda_cityscapes_to_acdc_fog_512x512.py',
...
name = 'city_acdc_fog_uda_warm_fdthings_rcs_croppl_a999_daformer_mitb5_s0'
exp = 'basic'
#name_dataset = 'gta2cityscapes'
name_dataset = 'cityscapes2acdcfog'
